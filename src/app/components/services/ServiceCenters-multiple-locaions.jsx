...
const ServiceCenters = () => {
  const centers = [
    ...
    },
    {
      ...
      mapUrl:
        "https://maps.google.com/?q=Plot+456,+CDA+Avenue,+GEC+Circle,+Chattogram+4000",
    },
    {
      ...
      mapUrl:
        "https://maps.google.com/?q=Plot+789,+KDA+Avenue,+Sonadanga,+Khulna+9100",
    },
  ];
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {center.features.map((feature, i) => (
                    <span
                      key={i}
                      className="text-xs bg-black border border-gray-800 text-gray-300 px-2 py-1"
                    >
                      {feature}
                    </span>
                  ))}
        ...
        >
          ...
          <div className="p-0">
            <div className="w-full h-[500px] relative">
              ...
              <div className="absolute top-4 right-4 bg-black bg-opacity-80 p-4 border border-gray-800 z-10 max-w-xs">
                ...
                <div className="space-y-2">
                  {centers.map((center, index) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center p-2 hover:bg-primary-600 bg-black bg-opacity-70 transition-colors group"
                    >
                      <div className="w-6 h-6 rounded-full bg-primary-600 flex items-center justify-center mr-2 text-white text-xs font-bold">
                        {index + 1}
                      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-black bg-opacity-50 border border-gray-800 p-8 border-t-4 border-t-primary-600">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Experience the premium service that your Chery deserves. Our
                factory-trained technicians use advanced diagnostic tools and
                genuine parts to keep your vehicle in optimal condition.
              </p>
