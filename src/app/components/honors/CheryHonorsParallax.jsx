              ...
              >
                ...
                <div className="lg:col-span-5 lg:pr-4 order-1">
                  <motion.div
                    ...
                    className="bg-black/55 backdrop-blur-sm p-6 sm:p-8  shadow-xl"
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
                      {stats.map((stat, index) => (
                        <motion.div 
                          key={stat.label}
                          className="text-center p-3 sm:p-4 bg-black/40  border-t-2 border-primary/40"
                    ...
                    >
                      <Link href="/achievements" legacyBehavior>
                        <a className="bg-primary hover:bg-primary-dark text-white px-4 sm:px-6 py-2.5 sm:py-3  font-medium transition-colors inline-flex items-center group text-sm sm:text-base">
                ...
                <div className="lg:col-span-7 relative order-2 min-h-[350px] sm:min-h-[380px]">
                  ...
                  {honors.map((honor, index) => (
                    ...
                    >
                      <div className="bg-black/50 backdrop-blur-md p-5 sm:p-6 md:p-8  shadow-xl border-l-4 border-primary h-full">
                        <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-6">
                          <span className="bg-primary text-white text-xs sm:text-sm py-1 sm:py-1.5 px-3 sm:px-4  font-medium inline-block">
                            {honor.year}
                          </span>
                          <span className="bg-white/10 text-white text-xs sm:text-sm py-1 sm:py-1.5 px-3 sm:px-4  inline-block">
                        ...
                        <div className="flex flex-wrap justify-between items-center gap-3 sm:gap-4 mt-auto">
                          <Link href={honor.link || "#"} legacyBehavior>
                            <a className="text-primary hover:text-primary-light flex items-center transition-colors group bg-black/30 px-3 sm:px-4 py-1.5 sm:py-2  text-sm sm:text-base">
                ...
                <div className="order-3 w-full flex justify-center lg:hidden mt-4">
                  <div className="flex gap-3 items-center">
                    <button
                      ...
                      className="bg-black/40  p-2 text-white"
