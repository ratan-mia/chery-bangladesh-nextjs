...
const BrandCoreGrid = ({
  ...
  sectionData = [
    {
      ...
      gradient:
        "linear-gradient(135deg, rgba(40,180,120,0.05) 0%, rgba(40,150,80,0.1) 100%)",
    },
    {
      title: "TECHNOLOGY",
      items: [
      ...
      gradient:
        "linear-gradient(135deg, rgba(50,50,180,0.05) 0%, rgba(90,90,200,0.1) 100%)",
    },
    {
      title: "FAMILY",
      items: [
      ...
      textColor: "text-white/80",
      gradient:
        "linear-gradient(135deg, rgba(180,100,50,0.05) 0%, rgba(150,80,40,0.1) 100%)",
    },
    {
      title: "COMPANIONSHIP",
      items: [
      ...
      textColor: "text-white/80",
      gradient:
        "linear-gradient(135deg, rgba(100,50,150,0.05) 0%, rgba(80,40,120,0.1) 100%)",
    },
  ],
}) => {
  ...
  return (
    <div className="w-full relative overflow-hidden bg-white">
      ...
      {/* Enhanced background texture overlay */}
      <div className="absolute inset-0 z-0 pointer-events-none opacity-10 mix-blend-soft-light">
        <svg
          width="100%"
          height="100%"
          viewBox="0 0 200 200"
        ...
        >
          <defs>
            <pattern
              ...
              height="16"
            >
              <circle cx="2" cy="2" r="0.8" fill="#000" opacity="0.15" />
              <circle cx="8" cy="8" r="0.6" fill="#000" opacity="0.1" />
              <circle cx="14" cy="14" r="0.4" fill="#000" opacity="0.08" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#enhanced-texture)" />
        </svg>
      </div>

      <div className="w-full max-w-[2000px] mx-auto px-4 md:px-8 lg:px-12 relative z-10 py-12">
          ...
          >
            <motion.div
              ...
              style={{
                ...
                filter:
                  hoveredSection === "brand"
                    ? "brightness(0.95)"
                    : "brightness(0.85)",
                transform:
                  hoveredSection === "brand" ? "scale(1.05)" : "scale(1)",
              }}
            />
          ...
          <div className="w-full lg:w-[60%]">
            <div className="grid grid-cols-1 sm:grid-cols-2 h-full">
              ...
              <motion.div
                className={`${
                  hoveredSection === 0
                    ? sectionData[0].hoverBgColor
                    : sectionData[0].bgColor
                } p-8 flex flex-col justify-between transition-colors duration-300 cursor-pointer relative overflow-hidden`}
              ...
              <motion.div
                className={`${
                  hoveredSection === 1
                    ? sectionData[1].hoverBgColor
                    : sectionData[1].bgColor
                } p-8 flex flex-col justify-between transition-colors duration-300 cursor-pointer relative overflow-hidden col-span-1 sm:col-span-1`}
                style={{ minHeight: { xs: "250px", lg: "300px" } }}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true }}
              ...
              <motion.div
                className={`${
                  hoveredSection === 2
                    ? sectionData[2].hoverBgColor
                    : sectionData[2].bgColor
                } p-8 flex flex-col justify-between transition-colors duration-300 cursor-pointer relative overflow-hidden`}
                style={{ minHeight: { xs: "250px", lg: "300px" } }}
                initial="hidden"
                whileInView="visible"
              ...
              <motion.div
                className={`${
                  hoveredSection === 3
                    ? sectionData[3].hoverBgColor
                    : sectionData[3].bgColor
                } p-8 flex flex-col justify-between transition-colors duration-300 cursor-pointer relative overflow-hidden col-span-1 sm:col-span-1`}
                style={{ minHeight: { xs: "250px", lg: "300px" } }}
                initial="hidden"
                whileInView="visible"
