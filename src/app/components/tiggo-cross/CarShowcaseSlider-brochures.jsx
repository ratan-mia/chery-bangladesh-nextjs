...
// Default vehicle data based on the Chery Tiggo Cross brochure
const defaultVehicles = [
  {
    id: "tiggo-cross-exterior",
    modelName: "EXTERIOR",
    modelYear: "2025",
  ...
  },
  {
    ...
    specs: {
      ...
      airbags: "7 Airbags",
      comfort: "Integrated Sport Seats"
    },
    features: [
      "10.25-inch Ultra-Clear LCD Screen with Full HD Display",
                  ...
                  <div className="absolute bottom-0 left-0 right-0 z-20 p-4 md:p-8 lg:p-10">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
                      ...
                      <div className="flex flex-col justify-end md:col-span-7">
                        ...
                        {/* Feature list - Added from brochure data */}
                        <div className="mb-6 hidden md:block">
                          <h3 className="text-sm uppercase tracking-wider text-gray-500 mb-2">Key Features</h3>
                          <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            {image.vehicleInfo.features.slice(0, 4).map((feature, idx) => (
                              <li key={idx} className="flex items-start text-sm" style={{ color: themeColors.textMuted }}>
                                <span className="mr-2 text-xs mt-1" style={{ color: themeColors.accent }}>✓</span>
                                {feature}
                              </li>
                            ))}
                          </ul>
