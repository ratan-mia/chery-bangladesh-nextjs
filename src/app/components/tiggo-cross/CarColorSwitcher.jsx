  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold text-[#7A6A58] mb-8 text-center">Premium Features</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="relative overflow-hidden group">
              <div className="relative overflow-hidden">
                <Image
                  src="/images/tiggocross/feature-tiger-face.webp"
                  alt="Biomimetic Tiger Face Design"
                  className="w-full aspect-[4/3] object-cover transition-transform duration-500 group-hover:scale-105"
                  width={400}
                  height={300}
                />
                <div className="absolute inset-0 bg-[#7A6A58]/20 group-hover:bg-[#7A6A58]/0 transition-all duration-500"></div>
              </div>
              <div className="p-6 bg-white border border-t-0 border-[#E5E0DB] group-hover:border-[#7A6A58] transition-colors duration-300">
                <h3 className="text-xl font-bold text-[#7A6A58] mb-2">Premium Paint Quality</h3>
                <p className="text-[#7A6A58] mb-4">Advanced multi-layer coating technology provides exceptional depth and durability.</p>
                <a
                  href="#learn-more"
                  className="inline-flex items-center text-[#7A6A58] font-medium hover:text-[#65584A] transition-colors duration-300"
                >
                  Learn More
            ...
            <div className="relative overflow-hidden group">
              <div className="relative overflow-hidden">
                <Image
                  src="/images/tiggocross/feature-interior.webp"
              ...
              <div className="p-6 bg-white border border-t-0 border-[#E5E0DB] group-hover:border-[#7A6A58] transition-colors duration-300">
                <h3 className="text-xl font-bold text-[#7A6A58] mb-2">5-Year Color Warranty</h3>
                <p className="text-[#7A6A58] mb-4">Our special formulation resists fading and maintains its vibrant finish for years.</p>
                <a
                  href="#learn-more"
                  className="inline-flex items-center text-[#7A6A58] font-medium hover:text-[#65584A] transition-colors duration-300"
                >
            ...
            <div className="relative overflow-hidden group">
              <div className="relative overflow-hidden">
                <Image
                  src="/images/tiggocross/feature-safety.webp"
              ...
              <div className="p-6 bg-white border border-t-0 border-[#E5E0DB] group-hover:border-[#7A6A58] transition-colors duration-300">
                <h3 className="text-xl font-bold text-[#7A6A58] mb-2">Matched Interior Options</h3>
                <p className="text-[#7A6A58] mb-4">Each exterior color is thoughtfully paired with complementary interior trim packages.</p>
                <a
                  href="#learn-more"
                  className="inline-flex items-center text-[#7A6A58] font-medium hover:text-[#65584A] transition-colors duration-300"
                >
          ...
          <div className="mt-12 md:mt-16 text-center">
            <Link 
              href="#view-more" 
              className="group inline-flex items-center text-sm font-medium text-[#7A6A58] tracking-wider uppercase hover:text-[#65584A] transition-colors duration-300"
            >
              VIEW ALL FEATURES
              <ArrowRight
                size={16}
