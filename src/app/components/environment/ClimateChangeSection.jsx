  ...
  return (
    <section
      ...
      className={`relative w-full overflow-hidden ${className} ${
        themeVariant === "light" ? "bg-white border-t border-gray-100" : ""
      }`}
      style={{ minHeight }}
    >
      {/* Background Image */}
      ...
      {/* Content Wrapper */}
      <div
        className={`relative z-20 max-w-${contentWdth} mx-auto px-4 md:px-8 py-16 md:py-24`}
      >
              ...
              {showStats && stats?.length > 0 && (
                <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6">
                  {stats.map(({ value, label }, index) => (
                    <div
                      key={index}
                      className="text-center border-t border-l border-r border-gray-200 py-6 px-4"
                    >
                      <div
