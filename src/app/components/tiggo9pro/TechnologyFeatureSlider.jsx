...
const TechnologyFeatureSlider = () => {
  ...
  return (
    <section 
      className="w-full py-16 md:py-24 bg-[#7d6653] relative overflow-hidden"
    ...
    >
      ...
      <div className="max-w-full mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 relative">
        {/* Section header */}
        <div className="max-w-7xl mx-auto mb-16 md:mb-20">
          ...
          >
            <motion.h2 
              ...
              className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 tracking-tight"
            >
              LEADING
              <br />
            ...
            <motion.p 
              variants={titleVariants}
              custom={1}
              className="text-white/90 max-w-2xl text-base md:text-lg lg:text-xl"
            >
        ...
        {/* Slider container with increased width */}
        <div 
          className="relative" 
          ref={sliderRef}
        ...
        >
            ...
            >
              {features.map((feature, index) => (
                <motion.div 
                  ...
                  custom={index}
                >
                  <div className="group h-full flex flex-col bg-[#8c735d]/10 backdrop-blur-sm p-0 transition-all duration-500 hover:bg-[#8c735d]/20">
                    ...
                    <div className="relative aspect-[4/3] overflow-hidden">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-primary-900/60 via-primary-900/20 to-transparent group-hover:from-primary-900/70 transition-all duration-500"></div>
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      {/* Feature title */}
                      <h3 className="text-white text-lg md:text-xl lg:text-2xl font-medium mb-3">
                        {feature.title}
                      </h3>
          ...
          <div className="flex items-center justify-between mt-12">
            ...
            <div className="flex flex-col w-4/5 md:w-3/4 lg:w-2/3">
              {/* Progress bar */}
            ...
            {/* Slide counter */}
            <div className="hidden md:flex items-center mr-6 text-white/80">
              <span className="text-primary-light font-medium">{currentIndex + 1}</span>
              <span className="mx-2">/</span>
              <span>{totalSlides - visibleSlides + 1}</span>
            </div>
