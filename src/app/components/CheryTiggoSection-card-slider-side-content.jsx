              ...
              <SwiperSlide key={index}>
                ...
                >
                  ...
                  >
                    ...
                    {/* Image Container */}
                    <div className="relative h-56 bg-gradient-to-b from-gray-100 to-white">
                      <motion.div
                        animate={{ 
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-primary-900/20 via-primary-900/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    </div>
                    ...
                    <div className="p-8">
                      ...
                      <p className="text-gray-600 text-sm leading-normal mb-8 line-clamp-3">
                        {model.description}
                      </p>
            ...
            >
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="flex-1 flex flex-col overflow-y-auto p-6">
                  {/* Image Section */}
                  <div className="relative h-64 bg-gradient-to-b from-gray-100 to-white mb-6">
                    <Image
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {selectedModel.specs.map((spec, idx) => (
                          <div 
                            key={idx} 
                            className="flex items-center space-x-3 p-3 bg-gray-100 border border-gray-200"
                          >
