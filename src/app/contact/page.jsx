...
import MediaPressInquiriesSection from "../components/contact/MediaPressInquiriesSection";
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(17, 24, 39, 0.98), rgba(17, 24, 39, 0.95))",
            }}
          />
        </div>
